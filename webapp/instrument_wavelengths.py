...
INSTRUMENT_WAVELENGTH_RANGE_NM: dict[tuple[str, str], tuple[float, float]] = {
    ...
    ('CARMENES Telluric-Corrected Template Library', 'CARMENES VIS'): (520, 960),
    ('CARMENES Telluric-Corrected Template Library', 'CARMENES NIR'): (960, 1710),
    ('CARMENES Reiners et al. 2018 Input Catalog', 'CARMENES VIS'): (520, 960),
    ('CARMENES Reiners et al. 2018 Input Catalog', 'CARMENES NIR'): (960, 1710),
    ...
    ('ING Archive (WHT/ISIS)', 'WHT/ISIS RED ARM'): (500, 1000),
    ('ING Archive (WHT/ISIS)', 'WHT/ISIS BLUE ARM'): (300, 550),
    ('Spitzer Heritage Archive (IRS + MIPS-SED)', 'Spitzer/IRS (Stare)'): (5200, 38000),
    ('Spitzer Heritage Archive (IRS + MIPS-SED)', 'Spitzer/IRS (Map)'): (5200, 38000),
    ('Spitzer Heritage Archive (IRS + MIPS-SED)', 'Spitzer/MIPS-SED'): (55000, 95000),
    ...
    ('IRSA Space-Mission Stellar Collections', 'Spitzer/IRS (FEPS)'): (5200, 38000),
    ('IRSA Space-Mission Stellar Collections', 'Spitzer/IRS (FEPS high-res)'): (9900, 37200),
    ('IRSA Space-Mission Stellar Collections', 'Spitzer/IRS (Disks SH)'): (9900, 19600),
    ('IRSA Space-Mission Stellar Collections', 'Spitzer/IRS (c2d)'): (5200, 38000),
