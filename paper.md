...
Claude’s Sonnet 5 was used to develop the software throughout the codebase. Sonnet 5 was also used to generate some of the text in the Summary and Statement of Need as well as for formatting and copy-editing. However, the writing can be largely credited to the author and the code was reviewed by the authors.
